...
PRICING_CATALOG: Dict[str, ServicePriceInfo] = {
    "translation": ServicePriceInfo(
        ...
        price_per_unit=0.01,
        currency="USDC",
        description="AI text translation ($0.01 per 100 characters, min $0.01)"
    ),
    "compute": ServicePriceInfo(
        ...
        price_per_unit=0.05,
        currency="USDC",
        description="High-performance execution engine ($0.05 per compute unit)"
    ),
    "storage": ServicePriceInfo(
        ...
        price_per_unit=0.02,
        currency="USDC",
        description="Cloud/IPFS decentralized storage ($0.02 per MB, min $0.01)"
    )
}
