...
PROVIDER_REGISTRY: Dict[str, ProviderInfo] = {
    "prov_trans_01": ProviderInfo(
        ...
        pricing=ProviderPricing(translation=0.00013, compute=0.00018, storage=0.00012, summarization=0.00014),
    ...
    "prov_trans_02": ProviderInfo(
        ...
        base_url="http://127.0.0.1:8000",
        pricing=ProviderPricing(translation=0.00018, compute=0.00020, storage=0.00015, summarization=0.00019),
    ...
    "prov_trans_03": ProviderInfo(
        ...
        base_url="http://127.0.0.1:8000",
        pricing=ProviderPricing(translation=0.00015, compute=0.00016, storage=0.00010, summarization=0.00016),
    ...
    "beta": ProviderInfo(
        ...
        wallet_address="0xB2C3D4E5F6A7B8C9D0E1F2A3B4C5D6E7F8A9B0C1",
        base_url="http://127.0.0.1:8000",
        pricing=ProviderPricing(translation=0.00005, compute=0.00012, storage=0.00008, summarization=0.00008),
