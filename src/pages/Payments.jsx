...
import { fetchAuditLogs, parseAuditLogsToTransactions, getSessionResetTime, consumeRecentPurchase } from '../services/api';
...
export default function Payments() {
  ...
  const totalSpentEth = transactions
    .filter(t => t.delivery_status === 'Delivered')
    .reduce((sum, t) => sum + (t.amount || 0), 0);
  const totalSpentFormatted = `${totalSpentEth.toFixed(4)} ETH`;
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <div className="flex items-center space-x-2">
            <h1 className="text-2xl font-black text-[#343434] tracking-tight">Agent Payments</h1>
            {isBackendLive ? (
          ...
          <p className="text-xs text-gray-500 font-medium mt-0.5">
            Trace every payment, provider quote, and task result generated by the AI Agent.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-12 gap-3">
          ...
          <div className="sm:col-span-5 relative">
            ...
            <input
              ...
              placeholder="Search by Task ID, Request ID, Service, Provider, or Tx..."
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-[#E9D8CC] text-[11px] font-mono font-bold text-gray-400 uppercase tracking-wider">
                  <th className="pb-3 px-3">Task ID / Request</th>
                    ...
                    >
                      <td className="py-3.5 px-3">
                        <div className="space-y-0.5">
                          <div className="font-mono font-bold text-[#343434]">
                            #{tx.request_id ? tx.request_id.slice(0, 14) : 'N/A'}...
                          </div>
                          {tx.task_id && tx.task_id !== tx.request_id && (
                            <span className="inline-flex items-center space-x-1 px-1.5 py-0.5 bg-[#E3F2FD] text-[#2563EB] rounded text-[9px] font-mono font-bold">
